...
The environmental dependencies are listed in CDFM3SF.yml. Researchers can re-produce the training and testing dataset by running Autoprocess.py (just replace the sorcedir in all .py file).
